...
func produtores(boxPrincipal* gtk.Box){
	...
	labelTituloProdutor,_ := gtk.LabelNew("Criar Produtor")

	boxTituloProdutor.PackStart(labelTituloProdutor, true, true, 10)
...
// Define os Rotulos
	...
	btn := setup_btn("Salvar", func() {
		...
		x := &Organismo{
			Base: Base{Tipo: "Produtor", Adulto: iadulto, Vida: ivida,Cor:tg},
